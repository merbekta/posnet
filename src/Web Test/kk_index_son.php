...
<form name="formName" method="post" action="<?php echo $ykbOOSURL; ?>" target="YKBWindow">
  <div align="center"> 
    ...
    <p>
      ...
      &nbsp;<A HREF="javascript:formName.submit()" onClick="submitFormEx(formName, <?php echo $openANewWindow; ?>, 'YKBWindow');this.disabled=true;"><FONT FACE="Geneva, Arial, Helvetica, sans-serif"><STRONG>Ödeme Yap</STRONG></FONT></A> <FONT SIZE="2">
      &nbsp;<input type="submit" name="Submit" value="Ödeme Yap" onClick="submitFormEx(formName, <?php echo $openANewWindow; ?>, 'YKBWindow');this.disabled=true;">
      </FONT></p>
  </div>
